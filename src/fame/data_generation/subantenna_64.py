...
from fame.data_generation.antenna_64 import Antenna
...
class SubAntenna(Antenna):
    def X_3_1(self, i, j, k):
        ...
        if (i in self.quark_indices and k in self.quark_indices):
            ...
            X_3_1 = self.N_c*self.D_3_1(i, j, k)
        elif (i in self.gluon_indices and j in self.gluon_indices):
            X_3_1 = self.N_c*self.F_3_1(i, j, k)
        return X_3_1
    ...
    def X_3_0(self, i, j, k):
        ...
        if (i in self.quark_indices and k in self.quark_indices):
            ...
            X_3_0 = self.N_c*self.all_d_3_0(i, j, k)
        elif (i in self.gluon_indices and j in self.gluon_indices):
            X_3_0 = self.N_c*self.all_f_3_0(i, j, k)
        return X_3_0
    ...
    def A_3_0(self, i, j, k):
        return np.sum(self.all_a_3_0(i, j, k), axis=0)
    ...
    def D_3_0(self, i, j, k):
        return np.sum(self.all_d_3_0(i, j, k), axis=0)
    ...
    def F_3_0(self, i, j, k):
        return np.sum(self.all_f_3_0(i, j, k), axis=0)
    
    def all_f_3_0(self, i, j, k):
        return np.array([self.f_3_0(i, k, j), self.f_3_0(k, j, i), self.f_3_0(j, i, k)])
