...
class DipoleModel():
    ...
    def build_model(self):
        ...
        inputs = [inputs_raw, rfs, sijs, dipoles, targets]
...
#         return tf.math.add(mse, f_pen)
    ...
    def dipole_network_predictor(self, model, inputs, momenta, CS, model_type="bare", batch_size=2**16):
